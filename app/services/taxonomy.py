...
CHECKLIST_PROFILES: dict[str, list[dict[str, str]]] = {
    "Common Equity": [
        ...
        {"id": "latest_earnings_release", "category_code": "earnings_release", "display_name": "Latest earnings release", "requirement_level": "required", "group": "Earnings and presentations"},
        {"id": "latest_earnings_presentation", "category_code": "earnings_presentation", "display_name": "Latest earnings presentation", "requirement_level": "required", "group": "Earnings and presentations"},
        {"id": "investor_overview", "category_code": "investor_presentation", "display_name": "Investor presentation or company overview", "requirement_level": "required", "group": "Earnings and presentations"},
        {"id": "earnings_transcript", "category_code": "earnings_transcript", "display_name": "Earnings transcript", "requirement_level": "recommended", "group": "Earnings and presentations"},
