...
CHECKLIST_PROFILES: dict[str, list[dict[str, str]]] = {
    "Common Equity": [
        ...
        {"id": "latest_earnings_release", "category_code": "earnings_release", "display_name": "Latest earnings release", "requirement_level": "recommended", "group": "Earnings and presentations"},
        {"id": "latest_earnings_presentation", "category_code": "earnings_presentation", "display_name": "Latest earnings presentation", "requirement_level": "recommended", "group": "Earnings and presentations"},
        {"id": "latest_investor_presentation", "category_code": "investor_presentation", "display_name": "Latest investor presentation", "requirement_level": "recommended", "group": "Earnings and presentations"},
